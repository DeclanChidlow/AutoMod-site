...
canonical: /docs/automod/setup
---

AutoMod is a pretty easy bot to get setup and ready to help moderate your server.

1. **Add AutoMod to your server**\
   If you're on the official Stoat instance, you can [directly invite it](https://stoat.chat/bot/01FHGJ3NPP7XANQQH8C2BE44ZY). If you're on another instance, you'll have to [self-host](/docs/automod/self-hosting) it.

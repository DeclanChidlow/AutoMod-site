---
title: Dashboard
description: Learn how to use AutoMod's dashboard to allow greater control of the bot and to use a greater range of features.
og_description: AutoMod's dashboard documentation.

---
title: AutoDice Documentation
description: Documentation for AutoDice. A fully featured dice bot for Stoat chat. Perfect for TTRPGs or other games and easy to use with intuitive syntax.
og_description: AutoDice's usage documentation.
canonical: /docs/autodice
---
...
If you need some help using AutoDice, you can get some over in the support channel on [the AutoMod Stoat server](https://stt.gg/automod).
